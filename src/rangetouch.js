(function(root, factory) {
  ...
  var settings = {
    ...
    thumbWidth: 15,
    selectors: {
      range: '.upwork-custom-image-slider',
  ...
  // Event listeners
  function listeners() {
    var sliders = document.getElementsByClassName('upwork-custom-image-slider');
    on(sliders, settings.events.start, set);
    on(sliders, settings.events.move, set);
    on(sliders, settings.events.end, set);
  }
